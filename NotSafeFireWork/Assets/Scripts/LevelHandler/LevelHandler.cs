...
public class LevelHandler : Singleton<LevelHandler>
{
	...
	private IEnumerator ChangeRoom()
	{
		...
		GameManager.Instance.playerControllers[1].gameObject.transform.position = new Vector3(listspawnPointsP1[currentState].transform.position.x, listspawnPointsP1[currentState].transform.position.y, GameManager.Instance.playerControllers[1].gameObject.transform.position.z);
		GameManager.Instance.playerControllers[0].gameObject.transform.position = new Vector3(listspawnPointsP2[currentState].transform.position.x, listspawnPointsP2[currentState].transform.position.y, GameManager.Instance.playerControllers[0].gameObject.transform.position.z);
		foreach (var item in GameManager.Instance.playerControllers)
		{
			item.LinkCorners();
